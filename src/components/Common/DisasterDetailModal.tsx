...
const DisasterDetailModal: React.FC<DisasterDetailModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-[99999] overflow-y-auto modal-overlay"
      style={{ zIndex: 99999 }}
    >
      {/* Backdrop */}
      <div
      ...
      {/* Modal */}
      <div
        className="flex min-h-full items-center justify-center p-4 pt-8 sm:pt-12 md:pt-16 relative z-[99999] modal-dialog"
        style={{ zIndex: 99999 }}
      >
        <div
          className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-y-auto z-[99999] modal-content"
          style={{ zIndex: 99999 }}
        >
          {/* Header */}
          <div
            className="sticky top-0 bg-white border-b border-gray-200 p-6 rounded-t-2xl z-[100000] modal-header"
            style={{ zIndex: 100000 }}
          >
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                This disaster alert was reported by {item.source} and is
                currently being monitored by official agencies.
                {item.severity === "critical" &&
                  " This is a critical event requiring immediate attention and may pose significant risk to life and property."}
                {item.severity === "high" &&
                  " This is a high-priority event requiring close monitoring and potential emergency response."}
                {item.severity === "medium" &&
                  " This event is being actively monitored and may develop into a more serious situation."}
                {item.severity === "low" &&
                  " This is a low-priority monitoring event with minimal immediate risk."}
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="text-blue-800">
                  <strong>Monitoring Status:</strong> Active - Real-time
                  tracking
                </p>
                <p className="text-blue-800">
