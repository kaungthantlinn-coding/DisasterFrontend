    ...
    <tr className="hover:bg-gray-50 transition-colors">
      <td className="px-6 py-4 whitespace-nowrap">
        <div className="flex items-center">
          <span className="text-lg mr-2">{getActionIcon()}</span>
          <div>
      ...
      <td className="px-6 py-4 whitespace-nowrap">
        ...
        {log.targetName && (
          <div className="text-sm text-gray-500 mt-1">{log.targetName}</div>
        )}
      </td>
      <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900 capitalize">{selectedLog.severity}</p>
                </div>
                <div>
