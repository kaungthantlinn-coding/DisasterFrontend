...
const authLoader = async (options?: {
  ...
  [
    ...
    // Main application routes
    {
      ...
      children: [
        ...
        {
          path: "cj-chat-list",
          element: <CjChatList onClose={() => window.history.back()} />,
        },
        ...
        {
          path: "verify-reports",
          element: <div>Verify Reports page coming soon...</div>,
          loader: () => authLoader({ requiredRoles: ["admin", "cj"] }),
        },
        {
          path: "analytics",
