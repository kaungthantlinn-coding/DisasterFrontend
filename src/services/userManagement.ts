...
export const userManagementApi = {
  // Create a new user
  createUser: async (userData: CreateUserRequest): Promise<UserWithPermissions> => {
  ...
  // Update a user
  updateUser: async (userId: string, userData: UpdateUserRequest): Promise<UserWithPermissions> => {
