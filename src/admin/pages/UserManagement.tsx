...
const UserManagement: React.FC = () => {
  ...
  const computedDisplayStats = {
    ...
    suspendedUsers: mappedUsers.filter(user => user.status === 'suspended').length,
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg">Manage users, roles, and permissions across your platform</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <button
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div className="group bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <dt className="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-2">Total Users</dt>
                <dd className="text-3xl font-bold text-gray-900 mb-1">{computedDisplayStats.totalUsers || 0}</dd>
          ...
          <div className="group bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <dt className="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-2">Active Users</dt>
                <dd className="text-3xl font-bold text-gray-900 mb-1">{computedDisplayStats.activeUsers || 0}</dd>
          ...
          <div className="group bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <dt className="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-2">Suspended</dt>
                <dd className="text-3xl font-bold text-gray-900 mb-1">{computedDisplayStats.suspendedUsers || 0}</dd>
          ...
          <div className="group bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <dt className="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-2">Administrators</dt>
                <dd className="text-3xl font-bold text-gray-900 mb-1">{computedDisplayStats.adminUsers || 0}</dd>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Find and filter users by various criteria</p>
                </div>
              </div>
              <div className="flex items-center space-x-3 bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-3 rounded-xl border border-blue-100">
                ...
                <span className="font-bold text-blue-700 text-lg">{totalCount || 0}</span>
                <span className="text-sm text-blue-600 font-medium">users found</span>
              </div>
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              <thead className="bg-gradient-to-r from-gray-50 via-blue-50/30 to-gray-50 border-b-2 border-gray-100">
                <tr>
                  <th className="px-8 py-6 text-left text-sm font-bold text-gray-800 uppercase tracking-wide cursor-pointer hover:bg-blue-50/50 transition-all duration-300 group"
                      onClick={() => handleSort('name')}>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></div>
                      <span className="group-hover:text-blue-700">User Information</span>
                      {localSortConfig.field === 'name' && (
                        <div className="w-6 h-6 bg-blue-100 rounded-lg flex items-center justify-center">
                          {localSortConfig.direction === 'asc' ? <ChevronUp className="w-4 h-4 text-blue-600" /> : <ChevronDown className="w-4 h-4 text-blue-600" />}
                        </div>
                      )}
                    </div>
                  </th>
                  <th className="px-8 py-6 text-left text-sm font-bold text-gray-800 uppercase tracking-wide cursor-pointer hover:bg-blue-50/50 transition-all duration-300 group"
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="group-hover:text-purple-700">Role & Permissions</span>
                      {localSortConfig.field === 'role' && (
                        <div className="w-6 h-6 bg-purple-100 rounded-lg flex items-center justify-center">
                          {localSortConfig.direction === 'asc' ? <ChevronUp className="w-4 h-4 text-purple-600" /> : <ChevronDown className="w-4 h-4 text-purple-600" />}
                        </div>
                      )}
                    </div>
                  </th>
                  <th className="px-8 py-6 text-left text-sm font-bold text-gray-800 uppercase tracking-wide cursor-pointer hover:bg-blue-50/50 transition-all duration-300 group"
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="group-hover:text-emerald-700">Account Status</span>
                      {localSortConfig.field === 'status' && (
                        <div className="w-6 h-6 bg-emerald-100 rounded-lg flex items-center justify-center">
                          {localSortConfig.direction === 'asc' ? <ChevronUp className="w-4 h-4 text-emerald-600" /> : <ChevronDown className="w-4 h-4 text-emerald-600" />}
                        </div>
                      )}
                    </div>
                  </th>
                  <th className="px-8 py-6 text-left text-sm font-bold text-gray-800 uppercase tracking-wide cursor-pointer hover:bg-blue-50/50 transition-all duration-300 group"
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="group-hover:text-indigo-700">Join Date</span>
                      {localSortConfig.field === 'joinDate' && (
                        <div className="w-6 h-6 bg-indigo-100 rounded-lg flex items-center justify-center">
                          {localSortConfig.direction === 'asc' ? <ChevronUp className="w-4 h-4 text-indigo-600" /> : <ChevronDown className="w-4 h-4 text-indigo-600" />}
                        </div>
                      )}
                    </div>
                  </th>
                  <th className="px-8 py-6 text-left text-sm font-bold text-gray-800 uppercase tracking-wide cursor-pointer hover:bg-blue-50/50 transition-all duration-300 group"
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="group-hover:text-orange-700">Activity</span>
                      {localSortConfig.field === 'reportsCount' && (
                        <div className="w-6 h-6 bg-orange-100 rounded-lg flex items-center justify-center">
                          {localSortConfig.direction === 'asc' ? <ChevronUp className="w-4 h-4 text-orange-600" /> : <ChevronDown className="w-4 h-4 text-orange-600" />}
                        </div>
                      )}
                    </div>
                  </th>
              ...
              <tbody className="bg-white divide-y divide-gray-50">
                {isLoading ? (
                  ...
                  Array.from({ length: pageSize || 10 }).map((_, index) => (
                    <tr key={`loading-${index}`} className="animate-pulse hover:bg-gray-25 transition-colors">
                    ...
                    <td colSpan={6} className="px-8 py-16 text-center">
                      <div className="flex flex-col items-center space-y-6">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 mb-6">{error.message || 'An error occurred while fetching users.'}</p>
                          <button
                            onClick={refresh}
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-6">
              ...
              <div className="hidden sm:flex items-center space-x-2 text-sm text-gray-600 bg-gray-100/70 px-4 py-2 rounded-xl">
                <span>Showing</span> 
                <span className="font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md">{computedStartIndex + 1}</span> 
                <span>to</span> 
                <span className="font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md">{computedEndIndex}</span> 
                <span>of</span> 
                <span className="font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md">{totalCount || 0}</span> 
                <span>results</span>
              </div>
            </div>
